...
from data_loader_abalone import dataloader_abalone

#init 

class neuNet_abalone(nn.Module):
...
custom_dateset = dataloader_abalone("./abalone/abalone.data")
